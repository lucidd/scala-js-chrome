...
/** @see
  *   <a href="https://developer.chrome.com/extensions/webNavigation">chrome.webNavigation API</a>
  */
@js.native
...
object WebNavigation extends js.Object {
  ...
  /** Retrieves information about the given frame. A frame refers to an <iframe> or a <frame> of a web page and is
    ...
    */
  def getFrame(details: GetFrameOptions, callback: js.Function1[FrameDetails, _]): Unit = js.native
  ...
  /** Retrieves information about all frames of a given tab.
    ...
    */
  def getAllFrames(details: GetAllFramesOptions, callback: js.Function1[js.Array[AllFramesDetails], _]): Unit =
    js.native
}
