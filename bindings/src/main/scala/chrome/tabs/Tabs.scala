...
object Tabs extends ChromeAPI {
  ...
  def connect(tabId: Tab.Id, connectInfo: js.UndefOr[ConnectInfo] = js.undefined): Port =
  ...
  def sendMessage(
      tabId: Tab.Id,
      message: js.Any,
      options: js.UndefOr[MessageOptions] = js.undefined
  ): Future[js.Any] = {
    val promise = Promise[js.Any]()
    bindings.Tabs.sendMessage(
      tabId,
      message,
      options,
      js.Any.fromFunction1((response: js.Any) => {
  ...
  def create(createProperties: TabCreateProperties): Future[Tab] = {
    val promise = Promise[Tab]()
    bindings.Tabs.create(
      createProperties,
      js.Any.fromFunction1((tab: Tab) => {
        promise.complete(lastErrorOrValue(tab))
      })
    )
    promise.future
  ...
  def duplicate(tabId: Tab.Id): Future[UndefOr[Tab]] = {
    ...
    bindings.Tabs
      .duplicate(
        tabId,
        js.Any.fromFunction1((tab: js.UndefOr[Tab]) => {
          promise.complete(lastErrorOrValue(tab))
        })
      )
    promise.future
  ...
  def highlight(highlightInfo: HighlightInfo): Future[Window] = {
    ...
    bindings.Tabs
      .highlight(
        highlightInfo,
        js.Any.fromFunction1((window: Window) => {
  ...
  def detectLanguage(tabId: js.UndefOr[Tab.Id] = js.undefined): Future[String] = {
    ...
    bindings.Tabs
      .detectLanguage(
        tabId,
        js.Any.fromFunction1((language: String) => {
  ...
  def captureVisibleTab(
      ...
      options: js.UndefOr[CaptureOptions] = js.undefined
  ): Future[String] = {
    val promise = Promise[String]()
  ...
  ): Future[js.UndefOr[js.Array[js.Any]]] = {
  ...
  def getZoom(tabId: js.UndefOr[Tab.Id] = js.undefined): Future[Double] = {
    ...
    bindings.Tabs.getZoom(
      tabId,
      js.Any.fromFunction1((zoomFactor: Double) => {
