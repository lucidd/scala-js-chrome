...
object Notifications extends js.Object {
  ...
  val onPermissionLevelChanged: Event[js.Function1[PermissionLevel, _]] = js.native
  val onShowSettings: Event[js.Function0[_]] = js.native

  def create(id: js.UndefOr[Id] = js.undefined,
             options: NotificationOptions,
             callback: js.UndefOr[js.Function1[Id, _]] = js.undefined): Unit = js.native

  def update(id: Id, options: NotificationOptions,
             callback: js.UndefOr[js.Function1[Boolean, _]] = js.undefined): Unit = js.native
  ...
  def getPermissionLevel(callback: js.Function1[PermissionLevel, _]): Unit = js.native
