...
object TCP extends js.Object {
  ...
  def update(socketId: SocketId, properties: SocketProperties, callback: js.Function0[_]): Unit = js.native
  def setPaused(socketId: SocketId, paused: Boolean, callback: js.Function0[_]): Unit = js.native
  ...
  def disconnect(socketId: SocketId, callback: js.Function0[_]): Unit = js.native
  def secure(socketId: SocketId, options: js.UndefOr[SecureOptions], callback: js.Function0[_]): Unit = js.native
