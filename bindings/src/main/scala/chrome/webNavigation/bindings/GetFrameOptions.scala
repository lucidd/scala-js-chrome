...
trait GetFrameOptions extends js.Object {
  ...
  /** Deprecated since Chrome 49. Frames are now uniquely identified by their tab ID and frame ID; the process ID is no
    * longer needed and therefore ignored. The ID of the process that runs the renderer for this tab.
    */
