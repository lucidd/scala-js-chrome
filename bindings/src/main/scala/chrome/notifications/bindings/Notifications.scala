...
object Notifications extends js.Object {
  ...
  def create(
      ...
      callback: js.UndefOr[js.Function1[Id, _]] = js.undefined
  ): Unit =
    js.native
  ...
  def update(
      id: Id,
      options: NotificationOptions,
      callback: js.UndefOr[js.Function1[Boolean, _]] = js.undefined
  ): Unit =
    js.native

  def clear(id: Id, callback: js.UndefOr[js.Function1[Boolean, _]] = js.undefined): Unit =
    js.native
