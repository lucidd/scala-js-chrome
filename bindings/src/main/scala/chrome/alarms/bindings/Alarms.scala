...
object Alarms extends js.Object {
  ...
  def clear(name: String = "", callback: js.UndefOr[js.Function1[Boolean, _]] = js.undefined): Unit =
    js.native

  def clearAll(callback: js.UndefOr[js.Function1[Boolean, _]] = js.undefined): Unit =
    js.native
