...
class WebRequestEventSourceImpl[T <: js.Function](event: WebRequestEvent[T]) extends WebRequestEventSource[T] {

  override def listen(
      callback: T,
      filter: RequestFilter,
      opt_extraInfoSpec: UndefOr[js.Array[String]] = js.undefined
  ): Subscription = {
